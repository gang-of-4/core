...
export async function createIndividualStoreApi(
  vendorId: string,
): Promise<Store> {
...
export async function createBusinessStoreApi(
  createBusinessStoreDto: CreateBusinessStoreDto,
): Promise<Store> {
