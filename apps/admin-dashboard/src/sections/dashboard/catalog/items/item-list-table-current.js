        ...
        <form noValidate onSubmit={formik.handleSubmit}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <Typography variant="h6">
                  {capitalize(config.catalog.item.name)} Details
                </Typography>
                <Divider sx={{ my: 2 }} />
                <Grid container spacing={3}>
                  ...
                  <Grid item md={6} xs={12}>
                    <TextField
                      ...
                      disabled
                      fullWidth
                      label={capitalize(config.catalog.category.plural)}
                      name="categories"
                    />
                  </Grid>
                  <Grid item md={6} xs={12}>
                  ...
                  {store && (
                    <Grid item md={6} xs={12}>
                      <TextField
                        defaultValue={store ? store.name : "N/A"}
                        disabled
                        fullWidth
                        label={`${capitalize(config.store.name)} Name`}
                        name="storeName"
                      />
                    </Grid>
                  )}
          ...
          >
            <Stack alignItems="center" direction="row" spacing={2}>
              ...
              <Button color="inherit" onClick={handleItemClose}>
                Cancel
              </Button>
            </Stack>
            <div>
              <Button onClick={() => handleItemDelete(item.id)} color="error">
                Delete {capitalize(config.catalog.item.name)}
              </Button>
            </div>
          </Stack>
        </form>
